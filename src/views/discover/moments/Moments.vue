...
<template>
  <div class="_full-container"
    ...
    <div class="_full-content"
         id="ko">
      <!-- 导航栏 -->
      <NavigationBar title="朋友圈"
                     :left-item="blackBackItem"
                     :right-item="cameraLineItem"
                     @left-click="$router.back()"
                     @right-click="cameraItemDidClick"
                     :style="navStyle"></NavigationBar>
      <NavigationBar :left-item="whiteBackItem"
                     :right-item="cameraFaceItem"
                     @left-click="$router.back()"
                     @right-click="cameraItemDidClick"
                     :style="transparentNavStyle"></NavigationBar>
      <!-- refreBall -->
  ...
  methods: {
    ...
    handleContentOrCommentRichText(dataKeyObj) {
      ...
      if (dataKeyObj[helper.linkUrlKey] || dataKeyObj[helper.topicKey]) {
        let value = dataKeyObj[helper.linkUrlKey] || dataKeyObj[helper.topicKey]
        console.log(value)
        this.$router.push({
          name: 'moments-other',
          params: {
